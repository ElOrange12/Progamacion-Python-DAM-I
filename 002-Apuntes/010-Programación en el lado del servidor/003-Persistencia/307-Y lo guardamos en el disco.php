...
<html>
	<head>
		<style>
			...
			header, footer, main{width:400px; padding:20px; background:white; text-align:center;}
		...
		<footer>
			...
			<?php
				if(isset($_POST['respuesta'])){
					...
					$archivo = fopen(date('U').'.json', 'w');	// Abre un archivo
					fwrite($archivo,$json);						// Guarda el archivo
