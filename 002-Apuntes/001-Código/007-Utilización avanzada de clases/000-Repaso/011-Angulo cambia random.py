...
class Npc():
    ...
    def mover(self):
    	self.direccion += self.direccion*(random.random()-0.5)*0.2	# por ejemplo, ±0.1 radianes
...
for i in range(0, numero_personajes):
    ...
    radio_aleatorio = random.randint(10, 30)
    direccion_aleatoria = random.random()*math.pi*2
    velocidad_aleatoria = random.random()*5
    personajes.append(Npc(xaleatoria, yaleatoria,radio_aleatorio, direccion_aleatoria, velocidad_aleatoria))
