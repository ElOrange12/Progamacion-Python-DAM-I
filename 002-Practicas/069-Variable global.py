...
class CuentaBancaria():
	...
	def setSaldo(self, nuevosaldo):
		# Establezco una condición de que valida si el saldo nuevo es mayot de 1000 euros
		if nuevosaldo > self.__saldo + limiteddiferenciasaldo:
